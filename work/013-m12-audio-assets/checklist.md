...
- CHK-011 [DEC-011] advisory: Accepted deferral DEC-011 remains visible to planning.
...
## Accepted Deferrals
- CR-011 [CHK:CHK-011] [DEC-011] acceptedDeferral: Accepted deferral DEC-011 remains visible to planning.
...
- Clarification decisions reviewed: 10.
- Next lifecycle action: `fsgg-sdd plan --work 013-m12-audio-assets`.
